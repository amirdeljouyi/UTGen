...
public class Budget_ESTest extends Budget_ESTest_scaffolding {
  ...
  public void testGetDailyAmountFromBudget() throws Throwable {
    ...
    assertEquals(10.25, dailyAmount);
  }
  ...
  public void testBudgetCaloriesPerHour() throws Throwable {
    ...
    var expected =  (int) (budget.getCaloriesPerHour() * (budget.getStartOfDay().minutesSince(new TimeOfDay(java.lang.System.currentTimeMillis()).minutesSince(budget.getStartOfDay())) / 60));
