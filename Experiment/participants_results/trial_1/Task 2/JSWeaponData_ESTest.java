...
public class JSWeaponData_ESTest extends JSWeaponData_ESTest_scaffolding {
  ...
  public void testToString()  throws Throwable  {
      ...
      assertEquals("WeaponGameData: minDmg=2075, maxDmg=2075, offBonus=2075, deffBonus=2075, name=de.outstare.fortbattleplayer.model.SectorBonus$BonusType", string0);
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasShinyWeaponOil()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(226, "de.outstare.fortbattleplayer.model.impl.SimpleWeapon", 226, 2384);
      boolean boolean0 = jSWeaponData0.hasShinyWeaponOil(simpleWeapon0);
      assertFalse(boolean0);
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasHipFlask()  throws Throwable  {
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(108, "@27|AN6-", 108, 108);
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      boolean boolean0 = jSWeaponData0.hasHipFlask(simpleWeapon0);
      assertFalse(boolean0);
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasLoadingchamberOrEnhancedPatrons()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(108, "S@27|AN6-", 1429, 1429);
      boolean boolean0 = jSWeaponData0.hasLoadingchamberOrEnhancedPatrons(simpleWeapon0);
      assertFalse(boolean0);
  }
  ...
  public void test()  throws Throwable  {
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(108, "S@27|AN6-", 17, 108);
      int int0 = simpleWeapon0.getSectorBonusAttack();
      assertEquals(0, int0);
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasBayonet()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(3, "127,200,296,0,0,Pr\u00E4ziser Hinterlader", 3, 3);
      boolean boolean0 = jSWeaponData0.hasBayonet(simpleWeapon0);
      assertFalse(boolean0);
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasGraphitLubricant()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon((-2704), "3jB;R`L#}*d:,!", 696, 696);
      boolean boolean0 = jSWeaponData0.hasGraphitLubricant(simpleWeapon0);
      assertFalse(boolean0);
  }
  ...
  public void testHasFettesWeaponOil()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon((-2704), "3jB;R`L#}*d:,!", 696, 696);
      boolean boolean0 = jSWeaponData0.hasFettesWeaponOil(simpleWeapon0);
      assertFalse(boolean0);
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testHasSchmierendesWeaponOil()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
      SimpleWeapon simpleWeapon0 = new SimpleWeapon(384, "FaR/O7/@@E<z", 384, 384);
      boolean boolean0 = jSWeaponData0.hasSchmierendesWeaponOil(simpleWeapon0);
      assertFalse(boolean0);
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetGoldenGoldAttBonus()  throws Throwable  {
      JSWeaponData jSWeaponData0 = new JSWeaponData();
  ...
  public void testMain()  throws Throwable  {
      ...
      JSWeaponData.main(stringArray0);
