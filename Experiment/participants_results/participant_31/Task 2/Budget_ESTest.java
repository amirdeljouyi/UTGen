...
//    Budget budget = new Budget(fixedClock);
    ...
    public void testGetDailyAmount() throws Throwable {
        ...
        TimeOfDay timeOfDay0 = new TimeOfDay(10, 15);
        budget0.setEndOfDay(timeOfDay0);
    ...
    public void testReplaceWith() throws Throwable {
        ...
        budget1.setCaloriesPerHour(1.0);
        budget1.setEndOfDay(new TimeOfDay(5));
        budget1.setStartOfDay(new TimeOfDay(3));
        budget1.setInterval(42);
        System.out.println(budget0.getCaloriesPerHour());
        System.out.println(budget1.getCaloriesPerHour());
        budget0.replaceWith(budget1);
        System.out.println(budget0.getCaloriesPerHour());
        System.out.println(budget1.getCaloriesPerHour());
        assertEquals(budget1.getCaloriesPerHour(), budget0.getCaloriesPerHour(), 0.01);
        assertEquals(budget1.getStartOfDay().toTime(), budget0.getStartOfDay().toTime());
        assertEquals(budget1.getEndOfDay().toTime(), budget0.getEndOfDay().toTime());
        assertEquals(budget1.getInterval(), budget0.getInterval());
    }
