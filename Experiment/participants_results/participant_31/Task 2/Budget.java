...
public class Budget extends ApplicationDataElementAdaptor
{
	...
	public int getDailyAmount() {
		...
		double time_diff_in_hours = (myEndOfDay.toTime() - myStartOfDay.toTime()) / 1000.0 / 60.0 / 60.0;
		double amt = myCaloriesPerHour * time_diff_in_hours;


		System.out.println(myEndOfDay);
		System.out.println(myStartOfDay);
		System.out.println(hours);
		System.out.println(time_diff_in_hours);
	...
	public int getBudgetFromTo(TimeOfDay start, TimeOfDay stop) {
		...
		//return amt;
		return (int) ((stop.toTime() - start.toTime()) / 1000.0 / 60.0 / 60.0 * myCaloriesPerHour);
	}
