...
public class JSWeaponData implements WeaponData {
	...
	public boolean isGoldenGun(final Weapon weapon) {
		final WeaponGameData weaponData = data.get(weapon.getId());
...
//		}
		...
		public boolean equals(Object o) {
			...
			if (!(o instanceof WeaponGameData)) return false;
			WeaponGameData that = (WeaponGameData) o;
			return id == that.id && minDamage == that.minDamage && maxDamage == that.maxDamage && bonusOffense == that.bonusOffense && bonusDefense == that.bonusDefense && Objects.equals(name, that.name);
		}
	}
