...
public class JSWeaponData_ESTest extends JSWeaponData_ESTest_scaffolding {
  ...
  public void testToStringMethod() throws Throwable {
    ...
    assertEquals(
        "WeaponGameData: minDmg=-3140, maxDmg=-3140, offBonus=25, deffBonus=1915, name=g7*W!u!NX3_YR/Xq", string);
  }
  ...
  public void testEqualsWithDefaultAndCustomValues() throws Throwable {
    ...
    assertEquals(
        "WeaponGameData: minDmg=17, maxDmg=17, offBonus=17, deffBonus=17, name=de.outstare.fortbattleplayer.model.impl.JSWeaponData$WeaponGameData",
  ...
  public void testWeaponEqualsSelf() throws Throwable {
    ...
    assertEquals(
        "WeaponGameData: minDmg=-3533, maxDmg=152, offBonus=152, deffBonus=2, name=Nachbedingung nicht erfüllt",
        testWeapon.toString());
    // And the weapon's toString() method should return a string representation of its properties in
    // the format "WeaponGameData: minDmg=<min damage>, maxDmg=<max damage>, offBonus=<offense bonus>, deffBonus=<defense bonus>, name=<name>"
  }
  ...
  public void testEqualsWithNullObject() throws Throwable {
    ...
    JSWeaponData.WeaponGameData weaponData =
        new JSWeaponData.WeaponGameData(
            0, 1, (-3531), 0, (-3531), "Rostige Flinte");
    ...
    assertEquals(
        "WeaponGameData: minDmg=1, maxDmg=-3531, offBonus=0, deffBonus=-3531, name=Rostige Flinte",
        weaponData.toString());
  }
}
