...
//    Budget budget = new Budget(fixedClock);
    ...
    public void testGetDailyAmount()  throws Throwable  {
        Budget budget0 = createBudgetWith24HDay();
        budget0.setCaloriesPerHour(1.0);
        int int0 = budget0.getDailyAmount();
        assertEquals(1.0, budget0.getCaloriesPerHour(), 0.01);
    ...
    public void testGetDailyAmountReturningNegative()  throws Throwable  {
        ...
        assertTrue(budget0.getDailyAmount() < 0, "Daily budget should be negative");
    }

    private static Budget createBudgetWith24HDay() {
        Budget budget0 = new Budget();
        budget0.setStartOfDay(new TimeOfDay(0, 0));
        budget0.setEndOfDay(new TimeOfDay(24, 0));
        return budget0;
    }
    ...
    public void testGetBudgetUpToNowReturningPositive()  throws Throwable  {
        Clock fixedClock = Clock.fixed(Instant.parse("2024-02-22T01:00:00.00Z"), ZoneId.of("UTC"));
