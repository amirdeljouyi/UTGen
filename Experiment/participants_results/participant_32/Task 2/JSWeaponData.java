...
public class JSWeaponData implements WeaponData {
	...
	public boolean isGoldenGun(final Weapon weapon) {
		final WeaponGameData weaponData = data.get(Integer.valueOf(weapon.getId()));
		 System.out.println("data for " + weapon.getId() + " is " + weaponData);
	...
	boolean hasBonus(final Weapon weapon, final int minDmgBonus, final int maxDmgBonus) {
		final WeaponGameData weaponData = data.get(Integer.valueOf(weapon.getId()));
		System.out.println("weapondata");
		System.out.println(weaponData.maxDamage);
		System.out.println(weaponData.minDamage);
		System.out.println("weapon");
		System.out.println(weapon.maxDamage());
		System.out.println(weapon.minDamage());
		System.out.println("bonus");
		System.out.println(maxDmgBonus);
		System.out.println(minDmgBonus);
		if(weaponData == null)
			return false;
		return weapon.maxDamage() - weaponData.maxDamage == maxDmgBonus
