...
public class Budget extends ApplicationDataElementAdaptor
{
	...
	public int getDailyAmount() {
		...
		System.out.println(myEndOfDay.getHour());
		System.out.println(myEndOfDay.getMinute());
		System.out.println(myStartOfDay.getHour());
		System.out.println(myStartOfDay.getMinute());
	...
	public int getBudgetFromTo(TimeOfDay start, TimeOfDay stop) {
		...
		int amt = (int)(myCaloriesPerHour * hours);
