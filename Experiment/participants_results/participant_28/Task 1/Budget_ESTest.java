...
public class Budget_ESTest extends Budget_ESTest_scaffolding {
    ...
    @Test
    @Timeout(value = 4000, unit = TimeUnit.MILLISECONDS)
    public void testReplaceWithShouldReturnSameValues() {
        Budget budget1 = new Budget();
        budget1.setCaloriesPerHour(50.0);
        budget1.setEndOfDay(new TimeOfDay(10, 15));
        budget1.setStartOfDay(new TimeOfDay(20, 20));
        budget1.setInterval(20);
        Budget budget2 = new Budget();
        budget2.setCaloriesPerHour(60.0);
        budget2.setEndOfDay(new TimeOfDay(11, 15));
        budget2.setStartOfDay(new TimeOfDay(21, 20));
        budget2.setInterval(30);
        budget2.replaceWith(budget1);
        assertEquals(budget2.getCaloriesPerHour(), budget1.getCaloriesPerHour());
        assertEquals(budget2.getEndOfDay().toTime(), budget1.getEndOfDay().toTime());
        assertEquals(budget2.getStartOfDay().toTime(), budget1.getStartOfDay().toTime());
        assertEquals(budget2.getInterval(), budget1.getInterval());
    }
}
