...
public class JSWeaponData implements WeaponData {
	...
	public int getGoldenGoldDeffBonus() {
		return WeaponData.GOLDEN_GUN_DEFENSE_BONUS; // Wrong this should be defense bonus
	}
	...
	public boolean isGoldenGun(final Weapon weapon) {
		...
		// weaponData);
		if (weaponData == null) {
			// Null check was forgotten here
			return false;
		}
		return (weaponData.bonusOffense > 0 || weaponData.bonusDefense > 0);
	}
