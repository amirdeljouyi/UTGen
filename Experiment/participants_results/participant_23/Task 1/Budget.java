...
//		hours = hours - minutes / 60.0;
		...
		double hoursDiff = (myEndOfDay.toTime() - myStartOfDay.toTime()) / 1000.0 / 60.0 / 60.0;

		double amt = myCaloriesPerHour * hoursDiff;
	...
	public int getBudgetFromTo(TimeOfDay start, TimeOfDay stop) {
		...
		int amt = 0;
		if (myCaloriesPerHour > 1.0) {
			amt = (int) (myCaloriesPerHour * hours);
		}

		System.err.println("myCaloriesPerHour = " + myCaloriesPerHour);
