...
public class Budget_ESTest extends Budget_ESTest_scaffolding {
    ...
    public void testGetDailyAmount()  throws Throwable  {
        ...
        budget0.setEndOfDay(new TimeOfDay(20, 0));
        //todo FIX 2 set end and start of day
    ...
    public void testReplaceWith() throws Throwable {
        ...
        budget2.setCaloriesPerHour(2);
        budget0.replaceWith(budget2);
        //TODO fix test; replace with another
        assertEquals(2.0, budget0.getCaloriesPerHour(), 0.01);
    }
