...
//        timeOfDay0.now();
    ...
    @Test
    @Timeout(value = 4000, unit = TimeUnit.MILLISECONDS)
    public void testReplaceWith2() throws Throwable {
        Budget budget0 = new Budget();
...
//        myStartOfDay = budget.myStartOfDay;
        budget1.setCaloriesPerHour(1234);
        var t1 = new TimeOfDay(12, 34);
        var t2 = new TimeOfDay(23, 45);
        budget1.setCaloriesPerHour(1337.0);
        budget1.setStartOfDay(t1);
        budget1.setEndOfDay(t2);
        budget1.setInterval(2345);
        budget0.replaceWith(budget1);
        assertEquals(1337.0, budget0.getCaloriesPerHour(), 0.01);
        assertEquals(t1, budget0.getStartOfDay());
        assertEquals(t2, budget0.getEndOfDay());
        assertEquals(2345, budget0.getInterval());
    }
    ...
    public void testGetBudgetUpToNowReturningPositive()  throws Throwable  {
        Clock fixedClock = Clock.fixed(Instant.parse("2024-02-28T10:15:30.00Z"), ZoneId.of("UTC"));
        Budget budget0 = new Budget(fixedClock);
