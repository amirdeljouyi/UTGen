...
public class Budget_ESTest extends Budget_ESTest_scaffolding {
  ...
  public void testGetStartOfDayReturningTimeOfDayWhereGetIdIsPositive()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = new TimeOfDay((-855), 1);
      timeOfDay0.setId(1752);
      budget0.setStartOfDay(timeOfDay0);
      TimeOfDay timeOfDay1 = budget0.getStartOfDay();
      assertFalse(timeOfDay1.getDirty());
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetStartOfDayReturningTimeOfDayWhereGetIdIsNegative()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = new TimeOfDay((-3727), (-1198));
      timeOfDay0.setId((-3727));
      budget0.setStartOfDay(timeOfDay0);
      TimeOfDay timeOfDay1 = budget0.getStartOfDay();
      assertEquals((-3727), timeOfDay1.getHour());
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetStartOfDayReturningTimeOfDayWhereGetHourIsPositive()  throws Throwable  {
      Budget budget0 = new Budget();
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetEndOfDayReturningNull()  throws Throwable  {
      Budget budget0 = new Budget();
      budget0.setEndOfDay((TimeOfDay) null);
      TimeOfDay timeOfDay0 = budget0.getEndOfDay();
      assertNull(timeOfDay0);
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetEndOfDayReturningTimeOfDayWhereGetIdIsPositive()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = new TimeOfDay();
      timeOfDay0.setId(1457);
      budget0.setEndOfDay(timeOfDay0);
      TimeOfDay timeOfDay1 = budget0.getEndOfDay();
      assertEquals(1457, timeOfDay1.getId());
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetEndOfDayReturningTimeOfDayWhereGetIdIsNegative()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = new TimeOfDay();
      timeOfDay0.setId((-2065));
      budget0.setEndOfDay(timeOfDay0);
      TimeOfDay timeOfDay1 = budget0.getEndOfDay();
      assertEquals((-2065), timeOfDay1.getId());
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetEndOfDayReturningTimeOfDayWhereGetHourIsNegative()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = new TimeOfDay((-1073741823), (-2710));
      budget0.setEndOfDay(timeOfDay0);
      TimeOfDay timeOfDay1 = budget0.getEndOfDay();
      assertEquals((-1073741823), timeOfDay1.getHour());
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testSetEndOfDay()  throws Throwable  {
      Budget budget0 = new Budget();
      budget0.setEndOfDay((TimeOfDay) null);
      budget0.postDeserialize();
      assertEquals(0, budget0.getId());
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetEndOfDayReturningTimeOfDayWhereGetDirtyIsTrue()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = budget0.getEndOfDay();
      timeOfDay0.setDirty(true);
      TimeOfDay timeOfDay1 = budget0.getEndOfDay();
      assertEquals(0, timeOfDay1.getId());
  }

  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testSetStartOfDayWithNull()  throws Throwable  {
      Budget budget0 = new Budget();
      budget0.setStartOfDay((TimeOfDay) null);
      budget0.postDeserialize();
      assertFalse(budget0.isDirty());
  }
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetIntervalReturningZero()  throws Throwable  {
      Budget budget0 = new Budget();
      long long0 = budget0.getInterval();
  ...
  @Test
  @Timeout(value = 4000 , unit = TimeUnit.MILLISECONDS)
  public void testGetStartOfDayReturningTimeOfDayWhereIsDirtyIsTrue()  throws Throwable  {
      Budget budget0 = new Budget();
      TimeOfDay timeOfDay0 = budget0.getStartOfDay();
      timeOfDay0.setDirty(true);
      TimeOfDay timeOfDay1 = budget0.getStartOfDay();
      assertTrue(timeOfDay1.getDirty());
  }
